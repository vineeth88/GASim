...
// Verilator Include
#include "verilated.h"
#include "bench/b10/cpp/Vtop__Syms.h"
#include "bench/b10/cpp/Vtop.h"

// User Defined Datatypes
#include "vType.h"

const int CONST_NUM_INPUT = 8;
const int CONST_NUM_INPUT_BITS = 11;
const int CONST_NUM_BRANCH = 32;
const int CONST_NUM_VARS = 7;
const int CONST_NUM_STATE_BITS = 14;
